                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-2xl font-semibold leading-snug text-slate-50 md:text-3xl">
                        {(active.blueprint as PlatformSpecificBlueprints)[selectedPlatform!]?.hook ?? (active.blueprint as unknown as VideoBlueprint).hook}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="mt-2 list-disc space-y-1 pl-5 text-base text-slate-100 md:text-lg">
                        {((active.blueprint as PlatformSpecificBlueprints)[selectedPlatform!]?.meat ?? (active.blueprint as unknown as VideoBlueprint).meat ?? []).map(
                          (point, idx) => (
                            <li key={idx}>{point}</li>
                          )
                        )}
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-lg font-medium text-slate-50 md:text-xl">
                        {(active.blueprint as PlatformSpecificBlueprints)[selectedPlatform!]?.cta ?? (active.blueprint as unknown as VideoBlueprint).cta}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm text-slate-200 md:text-base">
                        {(active.blueprint as PlatformSpecificBlueprints)[selectedPlatform!]?.setup_tip ?? (active.blueprint as unknown as VideoBlueprint).setup_tip}
                      </p>
                    </div>
